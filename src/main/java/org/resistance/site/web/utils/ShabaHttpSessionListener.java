...
@Service
public class ShabaHttpSessionListener extends HttpSessionEventPublisher
    implements ApplicationContextAware, ApplicationListener<SessionDestroyedEvent> {
  ...
  public void onApplicationEvent(SessionDestroyedEvent event) {
    for (SecurityContext securityContext : event.getSecurityContexts()) {
      ...
      if (USER_TRACKER.contains(ud)) {
        ...
        if (user != null) USER_TRACKER.removeUser(user);
      }
    }
  }
}
