...
var UserManagementWidget = function()
{
    ...
    global.makeUserManagementWidget = function(parentElement)
    {
        ...
        function retrieveUsers(localAccess)
        {
            ...
            function(users)
            {
                ...
                function(i, user)
                {
                    ...
                    $("#userTable").append(
                    $("<tr class='userRow' user='" + user.username + "'>")
                    .append(
                    $("<td>").append(
                    $("<span>" + user.username + "</span>").prepend(
                    $("<input class='selectUser' user='" + user.username
        ...
        function updateUser()
        {
            ...
            location = "userDetails/" + user + ".user";
        }
        ...
        $("#userTableHeader").append($("<th class='header'>Username</th>"))
